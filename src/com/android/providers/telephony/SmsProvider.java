...
public class SmsProvider extends ContentProvider {
    ...
    public Cursor query(Uri url, String[] projectionIn, String selection,
        ...
        switch (match) {
            ...
            case SMS_ALL_ICC:
                ret = getAllMessagesFromIcc();
                ret.setNotificationUri(getContext().getContentResolver(), ICC_URI);
                return ret;
            ...
            case SMS_ICC:
                {
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException(
                                "Wrong path segements for SMS_ICC, uri= " + url);
                    }
                    ret = getSingleMessageFromIcc(messageIndex);
                    ret.setNotificationUri(getContext().getContentResolver(), ICC_URI);
                    return ret;
                }
            ...
            case SMS_ALL_ICC_SUBID:
                {
                    ...
                    ret = getAllMessagesFromIcc(subId);
                    ret.setNotificationUri(getContext().getContentResolver(), ICC_SUBID_URI);
                    return ret;
                }
            ...
            case SMS_ICC_SUBID:
                {
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException(
                                "Wrong path segements for SMS_ICC_SUBID, uri= " + url);
                    }
                    ret = getSingleMessageFromIcc(subId, messageIndex);
                    ret.setNotificationUri(getContext().getContentResolver(), ICC_SUBID_URI);
                    return ret;
                }
        ...
        ret = qb.query(db, projectionIn, selection, selectionArgs, null, null, orderBy);
    ...
    /**
     * Gets single message from the ICC.
     *
     * @param messageIndex the message index of the messaage in the ICC.
     * @return a cursor containing just one message from the ICC.
     */
    private Cursor getSingleMessageFromIcc(int messageIndex) {
        return getSingleMessageFromIcc(
                SubscriptionManager.getDefaultSmsSubscriptionId(), messageIndex);
    }
    ...
    /**
     * Gets all the messages in the ICC.
     *
     * @return a cursor listing all the message in the ICC.
     */
            ...
            case SMS_ICC:
                {
                    ...
                    success = deleteMessageFromIcc(messageIndex);
            ...
            case SMS_ICC_SUBID:
                {
                    ...
                    // known.
                    getContext().getContentResolver().notifyChange(
                            ICC_SUBID_URI, null, true, UserHandle.USER_ALL);
                    return success ? 1 : 0; // return deleted count
                }
     ...
     */
    private boolean deleteMessageFromIcc(int messageIndex) {
