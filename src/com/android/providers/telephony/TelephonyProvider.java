...
import static android.provider.Telephony.Carriers.SKIP464XLAT;
import static android.provider.Telephony.Carriers.SKIP464XLAT_DEFAULT;
...
public class TelephonyProvider extends ContentProvider
{
    ...
    public static String getStringForCarrierTableCreation(String tableName) {
        return "CREATE TABLE " + tableName +
                ...
                SKIP464XLAT + " INTEGER DEFAULT " + SKIP464XLAT_DEFAULT + "," +
                ...
                // network_type_bitmask, skip464xlat.
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            if (oldVersion < (36 << 16 | 6)) {
                // Add a new column Carriers.SKIP464XLAT into the database and set the value to
                // SKIP464XLAT_DEFAULT.
                try {
                    db.execSQL("ALTER TABLE " + CARRIERS_TABLE + " ADD COLUMN " +
                            SKIP464XLAT + " INTEGER DEFAULT " + SKIP464XLAT_DEFAULT + ";");
        ...
        private void copyAllApnValues(ContentValues cv, Cursor c) {
            ...
            getIntValueFromCursor(cv, c, SKIP464XLAT);
        }
        ...
        private ContentValues getRow(XmlPullParser parser) {
            ...
            addIntAttribute(parser, "skip464xlat", map, SKIP464XLAT);
