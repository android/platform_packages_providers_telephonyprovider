...
import static android.provider.Telephony.Carriers.INVALID_APN_SET_ID;
...
public class TelephonyProvider extends ContentProvider
{
    ...
    static {
        ...
        CARRIERS_UNIQUE_FIELDS_DEFAULTS.put(APN_SET_ID, String.valueOf(INVALID_APN_SET_ID));
    ...
    public static String getStringForCarrierTableCreation(String tableName) {
        return "CREATE TABLE " + tableName +
                ...
                APN_SET_ID + " INTEGER DEFAULT " + INVALID_APN_SET_ID + "," +
