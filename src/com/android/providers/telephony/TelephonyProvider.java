...
import static android.provider.Telephony.Carriers.NO_APN_SET_ID_SET;
...
public class TelephonyProvider extends ContentProvider
{
    ...
    static {
        ...
        CARRIERS_UNIQUE_FIELDS_DEFAULTS.put(APN_SET_ID, String.valueOf(NO_APN_SET_ID_SET));
    ...
    public static String getStringForCarrierTableCreation(String tableName) {
        return "CREATE TABLE " + tableName +
                ...
                APN_SET_ID + " INTEGER DEFAULT " + NO_APN_SET_ID_SET + "," +
