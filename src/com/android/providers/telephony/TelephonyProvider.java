...
public class TelephonyProvider extends ContentProvider
{
    ...
    private static int mSimCount = SystemProperties.getInt(TelephonyProperties.PROPERTY_SIM_COUNT, 1);
    static {
        ...
        s_urlMatcher[PhoneConstants.SIM_ID_1].addURI("telephony", "siminfo", URL_SIMINFO);
    ...
    static private String getCarrierTableName(int simId) {
    ...
    static private String getPreferFileName(int simId) {
        if (simId == PhoneConstants.SIM_ID_1)
            return PREF_FILE;
        else
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            db.execSQL("CREATE TABLE " + SIMINFO_TABLE + "("
                    ...
                    + SimInfoManager.ICC_ID + " TEXT NOT NULL,"
                    + SimInfoManager.SIM_ID + " INTEGER DEFAULT " + SimInfoManager.SIM_NOT_INSERTED + ","
                    + SimInfoManager.DISPLAY_NAME + " TEXT,"
                    + SimInfoManager.NAME_SOURCE + " INTEGER DEFAULT " + SimInfoManager.DEFAULT_SOURCE + ","
                    + SimInfoManager.COLOR + " INTEGER DEFAULT " + SimInfoManager.COLOR_DEFAULT + ","
                    + SimInfoManager.NUMBER + " TEXT,"
                    + SimInfoManager.DISPLAY_NUMBER_FORMAT + " INTEGER NOT NULL DEFAULT " + SimInfoManager.DISLPAY_NUMBER_DEFAULT + ","
                    + SimInfoManager.DATA_ROAMING + " INTEGER DEFAULT " + SimInfoManager.DATA_ROAMING_DEFAULT
                    + ");");
    ...
    public Uri insert(Uri url, ContentValues initialValues)
    {
        ...
        switch (match)
        {
            ...
            case URL_SIMINFO: {
               ...
               result = ContentUris.withAppendedId(SimInfoManager.CONTENT_URI, id);
               break;
            }
        }
