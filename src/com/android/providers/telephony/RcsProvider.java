...
public class RcsProvider extends ContentProvider {
    ...
    private static final Uri GROUP_THREAD_URI_PREFIX = Uri.parse(
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            ...
            case P2P_THREAD_PARTICIPANT:
                ...
                break;
            case P2P_THREAD_PARTICIPANT_WITH_ID:
                return returnSameUriIfSuccessful(uri, mParticipantHelper.insertParticipantIntoP2pThread(uri));
            case GROUP_THREAD:
            ...
            case GROUP_THREAD_PARTICIPANT_WITH_ID:
                return returnSameUriIfSuccessful(uri, mParticipantHelper.insertParticipantIntoGroupThreadWithId(uri));
            default:
