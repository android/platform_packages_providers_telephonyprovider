...
import static android.provider.Telephony.RcsColumns.RcsMessageColumns.SEEN_TIMESTAMP_COLUMN;
...
public class RcsProviderMessageHelper {
    ...
    public static void createRcsMessageTables(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + RCS_INCOMING_MESSAGE_TABLE + "(" + MESSAGE_ID_COLUMN
                ...
                + ARRIVAL_TIMESTAMP_COLUMN + " INTEGER, " + SEEN_TIMESTAMP_COLUMN
    ...
    private ContentValues getIncomingMessageValues(ContentValues allValues) {
        ...
        if (allValues.containsKey(SEEN_TIMESTAMP_COLUMN)) {
            incomingMessageValues.put(
                SEEN_TIMESTAMP_COLUMN, allValues.getAsLong(SEEN_TIMESTAMP_COLUMN));
            allValues.remove(SEEN_TIMESTAMP_COLUMN);
        }
