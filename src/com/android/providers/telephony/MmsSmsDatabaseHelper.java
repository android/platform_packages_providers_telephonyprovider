...
public class MmsSmsDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void createCommonTables(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + MmsSmsProvider.TABLE_PENDING_MSG +" (" +
                   ...
                   PendingMessages.SUB_ID + " LONG DEFAULT 0," +
...
//                   "END;");
    ...
    private void upgradeDatabaseToVersion58(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + MmsProvider.TABLE_PDU +" ADD COLUMN " + Mms.SUB_ID + " LONG DEFAULT -1");
        db.execSQL("ALTER TABLE " + MmsSmsProvider.TABLE_PENDING_MSG +" ADD COLUMN " + PendingMessages.SUB_ID + " LONG DEFAULT 0");
        db.execSQL("ALTER TABLE " + SmsProvider.TABLE_SMS +" ADD COLUMN " + Sms.SUB_ID + " LONG DEFAULT -1");
        db.execSQL("ALTER TABLE " + SmsProvider.TABLE_RAW +" ADD COLUMN " + Sms.SUB_ID + " LONG DEFAULT -1");
    }
