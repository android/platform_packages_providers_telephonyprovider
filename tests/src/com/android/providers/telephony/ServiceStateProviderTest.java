...
public class ServiceStateProviderTest {
    ...
    public void testGetServiceStateForSubId() {
        ...
        Cursor cursor = mContentResolver.query(getUriForSubId(1), testProjection, "", null, null);
    ...
    public void testGetServiceState() {
        ...
        // testServiceState
        Cursor cursor = mContentResolver.query(ServiceStateTable.CONTENT_URI, testProjection, "",
                null, null);
        assertNotNull(cursor);
        cursor.moveToFirst();
