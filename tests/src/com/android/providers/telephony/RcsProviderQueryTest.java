...
import static android.provider.Telephony.RcsColumns.RcsParticipantEventTypes.PARTICIPANT_JOINED_EVENT_TYPE;
import static android.provider.Telephony.RcsColumns.RcsThreadColumns.RCS_THREAD_ID_COLUMN;
import static android.provider.Telephony.RcsColumns.RcsThreadEventColumns.DESTINATION_PARTICIPANT_COLUMN;
...
import static android.provider.Telephony.RcsColumns.RcsThreadEventColumns.OLD_NAME_COLUMN;
import static android.provider.Telephony.RcsColumns.RcsThreadEventColumns.ORIGINATING_PARTICIPANT_COLUMN;
...
import static android.telephony.ims.RcsParticipantQueryContinuationToken.PARTICIPANT_QUERY_CONTINUATION_TOKEN;
...
public class RcsProviderQueryTest {
    ...
    public void testCanQueryUnifiedThreadsWithLimitAndSorting() {
        RcsThreadQueryParameters queryParameters = RcsThreadQueryParameters.builder().setThreadType(
                RcsThreadQueryParameters.ONLY_1_TO_1_THREADS).limitResultsTo(1).sortBy(
                RcsThreadQueryParameters.TIMESTAMP).sortAscending(true).build();
        Bundle bundle = new Bundle();
        bundle.putParcelable(THREAD_QUERY_PARAMETERS_KEY, queryParameters);
    ...
    public void testCanContinueThreadQuery() {
        ...
        RcsThreadQueryParameters queryParameters =
                RcsThreadQueryParameters.builder().limitResultsTo(1).build();
        Bundle bundle = new Bundle();
        bundle.putParcelable(THREAD_QUERY_PARAMETERS_KEY, queryParameters);
        ...
        RcsThreadQueryContinuationToken continuationToken = cursor.getExtras().getParcelable(
    ...
    public void testQueryParticipantWithContinuation() {
        ...
        RcsParticipantQueryParameters queryParameters =
                new RcsParticipantQueryParameters.Builder().setAliasLike("%ali%").sortBy(
                        RcsParticipantQueryParameters.ALIAS).sortAscending(true).limitResultsTo(1)
                        .build();
        ...
        RcsParticipantQueryContinuationToken continuationToken = cursor.getExtras().getParcelable(
    ...
    public void testQueryEvents() {
        ...
        assertThat(cursor.getInt(cursor.getColumnIndex(ORIGINATING_PARTICIPANT_COLUMN))).isEqualTo(
                1);
        assertThat(cursor.getInt(cursor.getColumnIndex(DESTINATION_PARTICIPANT_COLUMN))).isEqualTo(
                2);

        cursor.moveToNext();
        assertThat(cursor.getInt(cursor.getColumnIndex(EVENT_TYPE_COLUMN))).isEqualTo(
                GROUP_THREAD_NAME_CHANGED_EVENT);
        assertThat(cursor.getString(cursor.getColumnIndex(OLD_NAME_COLUMN))).isEqualTo(
                "Old group name");
    ...
    public void testQueryEventsWithContinuation() {
        RcsEventQueryParameters queryParameters =
                RcsEventQueryParameters.builder().limitResultsTo(1).sortAscending(true).build();
    ...
    public void testQueryEventsWithTypeLimitation() {
        RcsEventQueryParameters queryParameters =
                RcsEventQueryParameters.builder().setEventType(
    ...
    public void testQueryMessagesWithContinuation() {
        RcsMessageQueryParameters queryParameters =
                RcsMessageQueryParameters.builder().setMessageLike("%o%message").limitResultsTo(
                        1).sortBy(RcsMessageQueryParameters.TIMESTAMP).sortAscending(true).build();
        Bundle bundle = new Bundle();
        bundle.putParcelable(MESSAGE_QUERY_PARAMETERS_KEY, queryParameters);
        ...
        // Perform the continuation query
        RcsMessageQueryContinuationToken continuationToken = cursor.getExtras().getParcelable(
    ...
    public void testQueryMessagesWithThreadFilter() {
        RcsMessageQueryParameters queryParameters =
                RcsMessageQueryParameters.builder().limitToThread(new RcsGroupThread(3)).build();
        Bundle bundle = new Bundle();
        bundle.putParcelable(MESSAGE_QUERY_PARAMETERS_KEY, queryParameters);
