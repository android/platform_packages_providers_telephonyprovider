...
public class TelephonyProviderTest extends TestCase {
    ...
    public void testInsertCarriers() {
        ...
        Log.d(TAG, "insert:aaaaaaaaaaaaaaaaaaaaaaaaaaa");
        Log.d(TAG, "insert:" + insertOwnedby);
        Log.d(TAG, "expected:" + expectedOwnedby);
        Log.d(TAG, "result:" + resultOwnedby);
        ...
        Log.d(TAG, "aaaaaaaaaaaaaatestInsertCarriers deleting selection: " + selectionToDelete
                + "testInsertCarriers selectionArgs: " + selectionArgs);
